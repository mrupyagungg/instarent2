        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center
                    ...
                    <h4 class="mb-sm-0 font-size-18">Laporan Pemasukan Kas</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:
                                    void(0);">Pemasukan Kas</a></li>
                            <li class="breadcrumb-item active">Laporan Pemasukan Kas</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form action="<?= base_url('laporan-pemasukan/filter') ?>" method="post">
                                <div class="row">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pemasukan as $data) : 
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right"> <?= nominal($data['jumlah']) ?> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td style="text-align:right"><?= nominal($total) ?></td>
                                    </tr>
                                </tfoot>    
                            </table>
                        </div>
