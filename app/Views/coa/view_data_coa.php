                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="coa" class="table align-middle dt-responsive nowrap table-striped"
...
<div id="add" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <form action="<?= base_url('coa/add') ?>" method="POST" class="no-validated">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="id_akun" placeholder="Nomor akun"
...
<?php foreach ($coa as $akun) : ?>
<div id="edit<?= $akun['id_akun']; ?>" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('coa/edit') ?>" method="POST" class="no-validated">
                    <div class="mb-3">
                        <label class="form-label">Nomor Akun</label>
                        <input type="number" class="form-control" name="id_akun" value="<?= $akun['id_akun'] ?>"
                            autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nama Akun</label>
                        <input type="text" class="form-control" name="nama_akun" value="<?= $akun['nama_akun'] ?>"
                            autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Posisi Akun</label>
...
<form action="<?= base_url('coa/delete') ?>" method="post">
    <div id="delete<?= $akun['id_akun']; ?>" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false"
