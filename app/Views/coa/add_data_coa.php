                    ...
                    <div class="card-body">
                        <form action="<?=base_url('coa/create')?>" method="POST" class="no-validated row g-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div>
                                    <div class="form check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kategori" value="pendapatan"
                                            <?= set_radio('kategori', 'pendapatan'); ?>>
                                        <label class="form-check-label" for="kategori_pendapatan">Pendapatan</label>
                                    </div>
                                    <div class="form check form-check-inline">
                                        <input class="form-check-input" type="radio" name="kategori" value="beban"
                                            <?= set_radio('kategori', 'beban'); ?>>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="posisi_d_c" id="posisi_d"
                                            value="d" <?= set_radio('posisi', 'd'); ?>>
                                        <label class="form-check-label" for="posisi_d">Debit (d)</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="posisi_d_c" id="posisi_c"
                                            value="c" <?= set_radio('posisi', 'c'); ?>>
