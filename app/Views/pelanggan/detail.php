            ...
            <div class="col-md-6">
                ...
                <form action="" method="POST" class="no-validated row g-3">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input class="form-control" type="email" id="email_pelanggan" name="email_pelanggan"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="number" class="form-control" name="no_telp_pelanggan" autocomplete="off"
                            maxlength="13" value="<?= old('no_telp_pelanggan') ?>">
                        <?php if (isset($validation)): ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="alamat_pelanggan" rows="3"
                            autocomplete="off"><?= old('alamat_pelanggan') ?></textarea>
                        <?php if (isset($validation)): ?>
